...
// this will counting backword 
for(let i = 110; i > 10; i--){
    console.log(i);
}

//Write an if statement that compares num1 to num2 and prints the larger of
 //the two. If they are equal, print "Num1 is equal to Num2"
